...
PMC_army1 loadStatus "army1_05";
PMC_army1 setDamage 0;
PMC_army2 loadStatus "army2_05";
PMC_army3 loadStatus "army3_05";
PMC_army4 loadStatus "army4_05";
PMC_army5 loadStatus "army5_05";
PMC_army6 loadStatus "army6_05";
PMC_army7 loadStatus "army7_05";
PMC_army8 loadStatus "army8_05";
PMC_army9 loadStatus "army9_05";
PMC_army10 loadStatus "army10_05";
...
titletext["Army squad in Estrella","plain down",2];

// assault1 leader
_camera camSetTarget leader assault1;
_camera camSetRelPos [-.5,1,1.3];
