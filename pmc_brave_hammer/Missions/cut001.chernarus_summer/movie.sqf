...
titleText ["PMC Brave Hammer, Chernarus Campaign","plain down",3];
sleep 5;
...
titleText ["The sovereign country of Chernarus is in turmoil.","plain down",3];
sleep 5;
...
titleText ["Terrorists that call themselves ''Chedaki'' have seized control.","plain down",3];
sleep 5;
...
titleText ["Local population are being systematically killed.","plain down",3];
sleep 5;
...
titleText ["Mass graves are being dug...","plain down",3];
sleep 3;
titleText ["Mass graves are being dug... daily.","plain down",3];
sleep 5;
...
titleText ["Russians are in the north, observing and supporting the Chedaki.","plain down",3];
sleep 5;
...
titleText ["Will this be the start of major conflict?","plain down",3];
sleep 5;
...
titleText ["Will the Russians get involved?","plain down",3];
sleep 5;
...
titleText ["Who will stop the slaugther of innocents?","plain down",3];
sleep 5;
...
titleText ["You're Marine Force Recon team leader on board the US carrier.\nThis is as close to a war you've been since the MFR training ended.","plain down",3];
sleep 8;

titleText ["Will you get to see some action?","plain down",3];
sleep 5;

titleText ["Will you survive if you do?","plain down",3];
sleep 5;

titleText ["Get ready for PMC Brave Hammer Chernarus Campaign!","plain down",3];
sleep 5;

4 fademusic 0;
titleText ["","plain down",4];
sleep 6;
