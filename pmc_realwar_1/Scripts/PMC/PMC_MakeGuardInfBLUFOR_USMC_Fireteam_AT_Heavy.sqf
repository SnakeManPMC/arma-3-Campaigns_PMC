...
PMC_MakeGuardInfBLUFOR_USMC_Fireteam_AT_Heavy =
{
	_grp = objNull;
	waitUntil
	{
	...
	"CUP_B_USMC_Soldier_AT" createUnit [_respawnpoint, _grp, "", (random 1), "LIEUTENANT"];
	"CUP_B_USMC_Soldier_AT" createUnit [_respawnpoint, _grp, "", (random 1), "SERGEANT"];
