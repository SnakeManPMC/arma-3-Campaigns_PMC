...
// 2
		...
		[
			...
			[
				"2. YOUR MISSION:",
				"Your M2A2 Bradleys <marker name='start'>start</marker> from Oss. Assault and win the towns of <marker name='target1'>Colmont</marker>, <marker name='target2'>Fortmond</marker>, <marker name='target3'>Kessel</marker>, and <marker name='target4'>Moorsel</marker>.<br/><br/>The big goal today is to clear the port town of Moorsel, far to the south, where the Reds have been getting in ship-borne reinforcements. Moorsel is shielded from our Otomat Mk2s by the bulk of the island, allowing the Reds to slip at least one fast destroyer convoy in from the south. This rat hole must be stopped up.<br/><br/>Your armored combat recon team will <marker name='start'>start</marker> from Oss. Your targets are like pearls on a string along the road leading south. Assault and win the towns of <marker name='target1'>Colmont</marker>, <marker name='target2'>Fortmond</marker>, <marker name='target3'>Kessel</marker>, and <marker name='target4'>Moorsel</marker>.<br/><br/>Rules of Engagement: Condition Red, weapons free. You need to wreck everything they've got on that entire stretch of road. Destroy everything at the target sites, including HMGs and trucks. Stay focused on killing the bad guys. Don't forget to grab the radio for the arty net. <br/><br/>"
			]
		];
