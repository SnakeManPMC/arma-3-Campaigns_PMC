...
[_grp, getPos pmc_2, 10] call PMC_Sentry_Inf_Waypoints;
_grp = [getPos pmc_3] call PMC_Create_CUP_NAPA_Random_Infantry;
[_grp, getPos pmc_3, 10] call PMC_Sentry_Inf_Waypoints;
_grp = [getPos pmc_4] call PMC_Create_CUP_NAPA_Random_Infantry;
[_grp, getPos pmc_4, 10] call PMC_Sentry_Inf_Waypoints;
_grp = [getPos pmc_5] call PMC_Create_CUP_NAPA_Random_Infantry;
[_grp, getPos pmc_5, 10] call PMC_Sentry_Inf_Waypoints;
_grp = [getPos pmc_6] call PMC_Create_CUP_NAPA_Random_Infantry;
[_grp, getPos pmc_6, 10] call PMC_Sentry_Inf_Waypoints;
