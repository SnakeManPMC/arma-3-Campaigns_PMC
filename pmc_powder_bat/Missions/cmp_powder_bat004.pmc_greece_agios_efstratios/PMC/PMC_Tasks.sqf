...
[player,["t1"],["Pass through and clear <marker name='pmc_marker_obj_1'>Strognos Bay area</marker> for any enemies.","Strognos Bay Area","text1"],(getPos pmc_1),1,2,true] call BIS_fnc_taskCreate;
