...
{
	sleep 30;
	systemChat format["%1, pmc_objective1: %2, pmc_objective2: %3, pmc_objective3: %4", time, pmc_objective1, pmc_objective2, pmc_objective3];
	(pmc_objective1 && pmc_objective2 && pmc_objective3);
};
