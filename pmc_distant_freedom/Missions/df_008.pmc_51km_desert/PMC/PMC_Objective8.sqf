/*
marker name: pmc_marker_obj_8
*/
sleep random 3;
systemChat "PMC_Objective8 running.";

private _pmcmarker = "pmc_marker_obj_8";
...
PMCHQ sideChat "Sector 7 cleared, keep moving and be safe. HQ over.";
sleep 7;
