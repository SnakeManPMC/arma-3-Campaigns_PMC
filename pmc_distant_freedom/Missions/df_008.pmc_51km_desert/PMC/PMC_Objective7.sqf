/*
marker name: pmc_marker_obj_7
*/
sleep random 3;
systemChat "PMC_Objective7 running.";

private _pmcmarker = "pmc_marker_obj_7";
...
PMCHQ sideChat "Sector 6 cleared, keep moving and be safe. HQ over.";
sleep 7;
