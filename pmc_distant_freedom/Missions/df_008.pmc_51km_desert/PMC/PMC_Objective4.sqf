/*
marker name: pmc_marker_obj_4
*/
sleep random 3;
systemChat "PMC_Objective4 running.";

private _pmcmarker = "pmc_marker_obj_4";
...
PMCHQ sideChat "Sector 3 cleared, keep moving and be safe. HQ over.";
sleep 7;
