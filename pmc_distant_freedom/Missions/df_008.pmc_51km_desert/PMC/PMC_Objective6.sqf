/*
marker name: pmc_marker_obj_6
*/
sleep random 3;
systemChat "PMC_Objective6 running.";

private _pmcmarker = "pmc_marker_obj_6";
...
PMCHQ sideChat "Sector 5 cleared, keep moving and be safe. HQ over.";
sleep 7;
