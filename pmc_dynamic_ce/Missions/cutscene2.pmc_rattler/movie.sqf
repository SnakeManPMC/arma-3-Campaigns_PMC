...
{_x setbehaviour "safe"; _x setformation "stag column"} foreach [hqteam,assault1,assault2,assault3,assault4,assault5,ranger1,ranger2,ranger3,seal1,seal2,ustanks1,ustanks2,ustanks3,ustanks4,ustanks5];
...
titletext["The war is over","plain",2];
sleep 5;
titletext["We have accomplished a lot during this campaign.","plain",2];
sleep 5;
...
waitUntil { (camCommitted _camera); };
titletext["HQ... you, remember.","plain down",2];
sleep 3;
titletext["You have done good job.","plain down",2];
sleep 5;
